...
entity Instruction_memory is
    port (
        ...
        rs_addr : out std_logic_vector(1 downto 0);       --Address of the register that holds the value of the first variable (A)
        rt_addr : out std_logic_vector(1 downto 0);       --Address of the register that holds the value of the second variable (B)
        rd_addr : out std_logic_vector(1 downto 0)        --Address of the destination register that holds the operation output value
    );
